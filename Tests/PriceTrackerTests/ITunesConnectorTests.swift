...
struct ITunesConnectorTests {
    @Test func freeUSAppIsResolvedAtZeroPrice() async throws {
        MockLookupURLProtocol.responseData = Data(#"{"resultCount":1,"results":[{"trackId":1053012308,"trackName":"Clash Royale","sellerName":"Supercell","currency":"USD","primaryGenreName":"Games","artworkUrl100":"https://example.com/icon.png","trackViewUrl":"https://apps.apple.com/us/app/clash-royale/id1053012308"}]}"#.utf8)
